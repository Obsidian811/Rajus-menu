  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-200 to-amber-200 text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center sm:items-center w-full">
        <h1 
        className=" text-3xl font-bold text-left -rotate-20 text-blue-800 sm:fixed sm:top-4 sm:left-4 sm:mx-0 sm:mt-2 sm:mb-0"
        // style={{
        ...
        <h1 
        className="pt-5 text-5xl font-bold mb-4 text-center bg-gradient-to-r from-blue-800 to-blue-950 text-transparent bg-clip-text sm:mb-8 sm:w-auto"
        style={{
          WebkitTextStroke: '0.5px white',
        }}
        >
